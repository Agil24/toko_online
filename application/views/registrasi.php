...
<body>
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg col-lg-6 my-5 mx-auto custom-card">
                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                                ...
                                <div class="form-group">
                                    <input type="username" class="form-control form-control-user" id="exampleInputEmail" placeholder="Username Anda" name="username">
                                ...
                                <button type="submit" class="btn btn-primary btn-user btn-block" style="background-color: #8B4513;">Daftar</button>
                            </form>
                            <hr>
                            <div class="text-center">
