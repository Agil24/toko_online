<div class="container-fluid">
    <button class="btn btn-sm btn-secondary mb-3" data-toggle="modal" data-target="#tambah_barang"><i class="fas fa-plus fa-sm "></i> Tambah Barang</button>
    ...
    <table class="table table-bordered">
        ...
        foreach ($barang as $brg) : ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo anchor('dashboard/detail/' . $brg->id_brg, '<div class="btn btn-sm btn-success"><i class="fas fa-search-plus"></i></div>') ?>
                </td>
